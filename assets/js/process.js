                    ...
                    if((fileType[1] == "sql")){
		                ...
		                $("#save_import").on("click",function(){
							...
							Materialize.toast('Starting database restoration.',2000,'',function(){
								var data = system.get_ajax('../assets/harmony/Process.php?drop-database',"");
								data.success(function(data){
									Materialize.toast('Restoring database (1/4).',2000,'',function(){
										Materialize.toast('Restoring database (2/4).',2000,'',function(){
											var data = system.get_ajax('../assets/harmony/Process.php?createDB',"");
											data.success(function(data){
												if(data == 1){
													Materialize.toast('Restoring database (3/4).',5000,'',function(){
